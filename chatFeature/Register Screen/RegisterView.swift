...
class RegisterView: UIView {
    ...
    func setupVerifyPassword(){
        verifyPassword = UITextField()
        verifyPassword.placeholder = "Re enter password"
        verifyPassword.keyboardType = .default
        verifyPassword.borderStyle = .roundedRect
    ...
    func initConstraints(){
        NSLayoutConstraint.activate([
            ...
            verifyPassword.topAnchor.constraint(equalTo: textFieldPassword.bottomAnchor, constant: 16),
            verifyPassword.centerXAnchor.constraint(equalTo: self.safeAreaLayoutGuide.centerXAnchor),
            verifyPassword.widthAnchor.constraint(equalTo: self.safeAreaLayoutGuide.widthAnchor, multiplier: 0.9),
            
            buttonRegister.topAnchor.constraint(equalTo: verifyPassword.bottomAnchor, constant: 32),
